...
static const PetAnimConfig s_pet_anim_configs[PET_ANIM_MAX] = {
    {PET_ANIM_IDLE,      "Idle",      "idle",      0, 6, 150}, /* Row 0: 待机 */
    {PET_ANIM_RUN_RIGHT, "Run Right", "run_right", 1, 8, 100}, /* Row 1: 向右跑 */
    {PET_ANIM_RUN_LEFT,  "Run Left",  "run_left",  2, 8, 100}, /* Row 2: 向左跑 */
    {PET_ANIM_WAVING,    "Waving",    "waving",    3, 4, 200}, /* Row 3: 挥手/打招呼 */
    {PET_ANIM_JUMPING,   "Jumping",   "jumping",   4, 5, 120}, /* Row 4: 跳跃 */
    {PET_ANIM_FAILED,    "Failed",    "failed",    5, 8, 150}, /* Row 5: 失败/受伤 */
    {PET_ANIM_WAITING,   "Waiting",   "waiting",   6, 6, 180}, /* Row 6: 等待/休息 */
    {PET_ANIM_RUNNING,   "Action",    "action",    7, 6, 100}, /* Row 7: 执行/动作 */
    {PET_ANIM_REVIEW,    "Inspect",   "inspect",   8, 6, 150}, /* Row 8: 思考/检查 */
    {PET_ANIM_DEADLOOP,  "Deadloop",  "deadloop",  9, 12, 90}  /* Row 9: 死循环告警 */
};
